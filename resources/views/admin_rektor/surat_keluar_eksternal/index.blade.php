...
<style>
    ...
    .badge-via {
        background-color: #fff3cd; border: 1px solid #ffecb5; color: #856404; /* Kuning untuk Eksternal */
    ...
    .dataTables_wrapper .dataTables_length select { padding-right: 30px; font-size: 0.85rem; }
    .dataTables_wrapper .dataTables_filter input { border: 1px solid #d1d3e2; border-radius: 4px; padding: 5px 10px; }
    .dataTables_wrapper .dataTables_paginate .page-item .page-link { color: #0d6efd; font-size: 0.85rem; }
    .dataTables_wrapper .dataTables_paginate .page-item.active .page-link { background-color: #0d6efd; border-color: #0d6efd; color: white; }
</style>
@endpush
...
<div class="container-fluid px-3 pt-2">
    ...
    <div class="filter-card shadow-sm">
        <div class="filter-body">
            {{-- Perhatikan Route Action ke Eksternal --}}
                ...
                <div class="row align-items-end g-3">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('adminrektor.surat-keluar-eksternal.index') }}" class="btn btn-outline-secondary w-100"><i class="bi bi-arrow-counterclockwise"></i> </a>
                        </div>
                    </div>
                    <div class="col-md-4 text-md-end">
                        <a href="{{ route('adminrektor.surat-keluar-eksternal.export', request()->query()) }}" class="btn btn-success text-white fw-bold me-2">
                            <i class="bi bi-file-earmark-excel me-1"></i> Export Excel
                        </a>
                        <a href="{{ route('adminrektor.surat-keluar-eksternal.create') }}" class="btn btn-primary text-white fw-bold">
                ...
                <table id="tabelSurat" class="table table-custom w-100">
                    <thead>
                        <tr>
                            ...
                            <th width="20%">Tujuan Eksternal</th> {{-- Judul Kolom Berbeda --}}
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    {{-- Edit Route Eksternal --}}
                                    <a href="{{ route('adminrektor.surat-keluar-eksternal.edit', $surat->id) }}" class="btn btn-sm btn-warning text-white shadow-sm" title="Edit">
                                        <i class="bi bi-pencil-fill" style="font-size: 0.8rem;"></i>
                                    </a>
                                    
                                    {{-- Delete Route Eksternal --}}
                                    <form action="{{ route('adminrektor.surat-keluar-eksternal.destroy', $surat->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus surat ini?');">
                                        @csrf
                                        @method('DELETE')
